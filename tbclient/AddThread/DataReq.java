...
public final class DataReq extends Message {
    ...
    public static final Long DEFAULT_PRIVATE_CHAT_PAGE_HEIGHT = 0L;
    public static final Long DEFAULT_PRIVATE_CHAT_PAGE_WIDTH = 0L;
    public static final Long DEFAULT_ACTIVITY_PRODUCT_ID = 0L;
    public static final Long DEFAULT_ACTIVITY_BUSINESS_ID = 0L;
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.private_chat_robot_uk = dataReq.private_chat_robot_uk;
            this.private_chat_page_height = dataReq.private_chat_page_height;
            this.private_chat_img = dataReq.private_chat_img;
            this.private_chat_msgkeys = dataReq.private_chat_msgkeys;
            this.private_chat_page_width = dataReq.private_chat_page_width;
            this.activity_product_id = dataReq.activity_product_id;
            this.activity_business_id = dataReq.activity_business_id;
            this.ext = dataReq.ext;
        }
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            String str81 = builder.private_chat_robot_uk;
            if (str81 == null) {
                this.private_chat_robot_uk = "";
            } else {
                this.private_chat_robot_uk = str81;
            }
            Long l = builder.private_chat_page_height;
            if (l == null) {
                this.private_chat_page_height = DEFAULT_PRIVATE_CHAT_PAGE_HEIGHT;
            } else {
                this.private_chat_page_height = l;
            }
            String str82 = builder.private_chat_img;
            if (str82 == null) {
                this.private_chat_img = "";
            } else {
                this.private_chat_img = str82;
            }
            String str83 = builder.private_chat_msgkeys;
            if (str83 == null) {
                this.private_chat_msgkeys = "";
            } else {
                this.private_chat_msgkeys = str83;
            }
            Long l2 = builder.private_chat_page_width;
            if (l2 == null) {
                this.private_chat_page_width = DEFAULT_PRIVATE_CHAT_PAGE_WIDTH;
            } else {
                this.private_chat_page_width = l2;
            }
            Long l3 = builder.activity_product_id;
            if (l3 == null) {
                this.activity_product_id = DEFAULT_ACTIVITY_PRODUCT_ID;
            } else {
                this.activity_product_id = l3;
            }
            Long l4 = builder.activity_business_id;
            if (l4 == null) {
                this.activity_business_id = DEFAULT_ACTIVITY_BUSINESS_ID;
            } else {
                this.activity_business_id = l4;
            }
            String str84 = builder.ext;
            if (str84 == null) {
                this.ext = "";
                return;
            } else {
        ...
        this.private_chat_robot_uk = builder.private_chat_robot_uk;
        this.private_chat_page_height = builder.private_chat_page_height;
        this.private_chat_img = builder.private_chat_img;
        this.private_chat_msgkeys = builder.private_chat_msgkeys;
        this.private_chat_page_width = builder.private_chat_page_width;
        this.activity_product_id = builder.activity_product_id;
        this.activity_business_id = builder.activity_business_id;
