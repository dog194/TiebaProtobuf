...
public final class BannerList extends Message {
    ...
    public static final List<App> DEFAULT_COMMENT_GAME_AD = Collections.emptyList();
    ...
    public static final class Builder extends Message.Builder<BannerList> {
        ...
        public Builder(BannerList bannerList) {
            ...
            this.comment_game_ad = Message.copyOf(bannerList.comment_game_ad);
        }
    ...
    public BannerList(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            List<App> list4 = builder.comment_game_ad;
            if (list4 == null) {
                this.comment_game_ad = DEFAULT_COMMENT_GAME_AD;
                return;
            } else {
                this.comment_game_ad = Message.immutableCopyOf(list4);
                return;
            }
        }
        ...
        this.comment_game_ad = Message.immutableCopyOf(builder.comment_game_ad);
    }
}