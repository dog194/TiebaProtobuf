...
public final class DataReq extends Message {
    ...
    @ProtoField(tag = 27)
    public final CommonReq f1556common;
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.pn = dataReq.pn;
            this.f1557common = dataReq.f1556common;
            ...
            this.page_source = dataReq.page_source;
        }
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            this.f1556common = builder.f1557common;
            ...
            Integer num26 = builder.request_times;
            if (num26 == null) {
                this.request_times = DEFAULT_REQUEST_TIMES;
            } else {
                this.request_times = num26;
            }
            Integer num27 = builder.page_source;
            if (num27 == null) {
                this.page_source = DEFAULT_PAGE_SOURCE;
                return;
            } else {
                this.page_source = num27;
                return;
            }
        }
