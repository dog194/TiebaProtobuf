...
public final class DataReq extends Message {
    ...
    @ProtoField(tag = 8)
    public final CommonReq f1540common;
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.f1541common = dataReq.f1540common;
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            this.f1540common = builder.f1541common;
            ...
            String str10 = builder.log_param;
            if (str10 == null) {
                this.log_param = "";
            } else {
                this.log_param = str10;
            }
            Integer num12 = builder.is_newfeed;
            if (num12 == null) {
                this.is_newfeed = DEFAULT_IS_NEWFEED;
                return;
            } else {
                this.is_newfeed = num12;
                return;
            }
        }
