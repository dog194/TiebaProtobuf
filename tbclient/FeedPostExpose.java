...
public final class FeedPostExpose extends Message {
    ...
    public static final Integer DEFAULT_CONTENT_MAX_LINES = 0;
    ...
    public static final class Builder extends Message.Builder<FeedPostExpose> {
        ...
        public Builder(FeedPostExpose feedPostExpose) {
            ...
            this.content_max_lines = feedPostExpose.content_max_lines;
        }
    ...
    public FeedPostExpose(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            Integer num = builder.content_max_lines;
            if (num == null) {
                this.content_max_lines = DEFAULT_CONTENT_MAX_LINES;
                return;
            } else {
                this.content_max_lines = num;
                return;
            }
        }
        ...
        this.head_agree = builder.head_agree;
        this.content_max_lines = builder.content_max_lines;
    }
}