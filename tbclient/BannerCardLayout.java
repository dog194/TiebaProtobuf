...
public final class BannerCardLayout extends Message {
    ...
    public static final class Builder extends Message.Builder<BannerCardLayout> {
        ...
        public Builder(BannerCardLayout bannerCardLayout) {
            super(bannerCardLayout);
            if (bannerCardLayout == null) {
                return;
            }
            this.components = Message.copyOf(bannerCardLayout.components);
            this.business_info = Message.copyOf(bannerCardLayout.business_info);
            this.log_param = Message.copyOf(bannerCardLayout.log_param);
            this.prefetch_schema = Message.copyOf(bannerCardLayout.prefetch_schema);
        }

        @Override // com.squareup.wire.Message.Builder
        public BannerCardLayout build(boolean z) {
            return new BannerCardLayout(this, z);
        }
    }

    public BannerCardLayout(Builder builder, boolean z) {
        super(builder);
        if (z) {
