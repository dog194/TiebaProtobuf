...
public final class SpriteMemeInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<SpriteMemeInfo> {
        ...
        public Builder(SpriteMemeInfo spriteMemeInfo) {
            ...
            this.meme_package_scheme = spriteMemeInfo.meme_package_scheme;
        }
    ...
    public SpriteMemeInfo(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            String str5 = builder.meme_package_scheme;
            if (str5 == null) {
                this.meme_package_scheme = "";
                return;
            } else {
                this.meme_package_scheme = str5;
                return;
            }
        }
        ...
        this.meme_package_scheme = builder.meme_package_scheme;
    }
}