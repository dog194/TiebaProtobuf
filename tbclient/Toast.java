...
public final class Toast extends Message {
    ...
    public static final Integer DEFAULT_IS_LIMIT_PAGE = 0;
    ...
    public static final class Builder extends Message.Builder<Toast> {
        ...
        public Builder(Toast toast) {
            ...
            this.scheme = toast.scheme;
            this.is_limit_page = toast.is_limit_page;
        }
    ...
    public Toast(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            String str5 = builder.scheme;
            if (str5 == null) {
                this.scheme = "";
            } else {
                this.scheme = str5;
            }
            Integer num5 = builder.is_limit_page;
            if (num5 == null) {
                this.is_limit_page = DEFAULT_IS_LIMIT_PAGE;
                return;
            } else {
                this.is_limit_page = num5;
                return;
            }
        }
        ...
        this.is_limit_page = builder.is_limit_page;
    }
}