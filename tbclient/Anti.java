...
public final class Anti extends Message {
    ...
    public static final Integer DEFAULT_HAS_SHIELD = 0;
    ...
    public static final class Builder extends Message.Builder<Anti> {
        ...
        public Builder(Anti anti) {
            ...
            this.has_shield = anti.has_shield;
        }
    ...
    public Anti(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            Integer num17 = builder.has_shield;
            if (num17 == null) {
                this.has_shield = DEFAULT_HAS_SHIELD;
                return;
            } else {
                this.has_shield = num17;
                return;
            }
        }
        ...
        this.has_shield = builder.has_shield;
    }
}