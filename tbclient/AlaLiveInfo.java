...
public final class AlaLiveInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<AlaLiveInfo> {
        ...
        public Builder(AlaLiveInfo alaLiveInfo) {
            ...
            this.ctr_fea = alaLiveInfo.ctr_fea;
            this.yy_source = alaLiveInfo.yy_source;
        }
    ...
    public AlaLiveInfo(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            String str24 = builder.ctr_fea;
            if (str24 == null) {
                this.ctr_fea = "";
            } else {
                this.ctr_fea = str24;
            }
            String str25 = builder.yy_source;
            if (str25 == null) {
                this.yy_source = "";
                return;
            } else {
                this.yy_source = str25;
                return;
            }
        }
        ...
        this.player_size = builder.player_size;
        this.container_size = builder.container_size;
        this.ctr_fea = builder.ctr_fea;
        this.yy_source = builder.yy_source;
    }
}