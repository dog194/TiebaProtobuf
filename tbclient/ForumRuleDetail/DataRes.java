...
public final class DataRes extends Message {
    ...
    public static final List<NewForumRule> DEFAULT_DEFAULT_RULES = Collections.emptyList();
    public static final List<NewForumRule> DEFAULT_NEW_RULES = Collections.emptyList();
    ...
    public static final class Builder extends Message.Builder<DataRes> {
        ...
        public Builder(DataRes dataRes) {
            ...
            this.default_rules = Message.copyOf(dataRes.default_rules);
            this.new_rules = Message.copyOf(dataRes.new_rules);
            this.forum_rule_conf = dataRes.forum_rule_conf;
        }
    ...
    public DataRes(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            List<NewForumRule> list2 = builder.default_rules;
            if (list2 == null) {
                this.default_rules = DEFAULT_DEFAULT_RULES;
            } else {
                this.default_rules = Message.immutableCopyOf(list2);
            }
            List<NewForumRule> list3 = builder.new_rules;
            if (list3 == null) {
                this.new_rules = DEFAULT_NEW_RULES;
            } else {
                this.new_rules = Message.immutableCopyOf(list3);
            }
            this.forum_rule_conf = builder.forum_rule_conf;
            return;
        }
        this.forum = builder.forum;
        ...
        this.default_rules = Message.immutableCopyOf(builder.default_rules);
        this.new_rules = Message.immutableCopyOf(builder.new_rules);
        this.forum_rule_conf = builder.forum_rule_conf;
    }
}