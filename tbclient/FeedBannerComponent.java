...
public final class FeedBannerComponent extends Message {
    ...
    public static final class Builder extends Message.Builder<FeedBannerComponent> {
        ...
        public Builder(FeedBannerComponent feedBannerComponent) {
            super(feedBannerComponent);
            if (feedBannerComponent == null) {
                return;
            }
            this.banner_url = feedBannerComponent.banner_url;
            this.banner_width = feedBannerComponent.banner_width;
            this.banner_high = feedBannerComponent.banner_high;
            this.jump_url = feedBannerComponent.jump_url;
            this.activity_id = feedBannerComponent.activity_id;
            this.show_statistics_urls = Message.copyOf(feedBannerComponent.show_statistics_urls);
            this.click_statistics_urls = Message.copyOf(feedBannerComponent.click_statistics_urls);
            this.scheme = feedBannerComponent.scheme;
            this.package_name = feedBannerComponent.package_name;
            this.download_info = feedBannerComponent.download_info;
        }

        @Override // com.squareup.wire.Message.Builder
        public FeedBannerComponent build(boolean z) {
            return new FeedBannerComponent(this, z);
        }
    }

    public FeedBannerComponent(Builder builder, boolean z) {
        super(builder);
        if (z) {
