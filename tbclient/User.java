...
public final class User extends Message {
    ...
    @ProtoField(tag = TTDownloadField.CALL_DOWNLOAD_MODEL_SET_VERSION_CODE, type = Message.Datatype.INT32)
    ...
    public static final List<ThemeColorInfo> DEFAULT_USER_MARK_LIST = Collections.emptyList();
    public static final List<UserAttrIcon> DEFAULT_SHOW_ICON_LIST = Collections.emptyList();
    ...
    public User(Builder builder, boolean z) {
        ...
        if (!z) {
            ...
            this.user_mark_list = Message.immutableCopyOf(builder.user_mark_list);
            this.show_icon_list = Message.immutableCopyOf(builder.show_icon_list);
            this.user_show_info = builder.user_show_info;
            this.log_param = Message.immutableCopyOf(builder.log_param);
            this.like_forum_scheme = builder.like_forum_scheme;
        ...
        List<ThemeColorInfo> list15 = builder.user_mark_list;
        if (list15 == null) {
            this.user_mark_list = DEFAULT_USER_MARK_LIST;
        } else {
            this.user_mark_list = Message.immutableCopyOf(list15);
        }
        List<UserAttrIcon> list16 = builder.show_icon_list;
        if (list16 == null) {
            this.show_icon_list = DEFAULT_SHOW_ICON_LIST;
        } else {
            this.show_icon_list = Message.immutableCopyOf(list16);
        }
        this.user_show_info = builder.user_show_info;
        List<FeedKV> list17 = builder.log_param;
        if (list17 == null) {
            this.log_param = DEFAULT_LOG_PARAM;
        } else {
            this.log_param = Message.immutableCopyOf(list17);
        }
        String str31 = builder.like_forum_scheme;
        if (str31 == null) {
            this.like_forum_scheme = "";
        } else {
            this.like_forum_scheme = str31;
        }
        Integer num56 = builder.pa_type;
        if (num56 == null) {
        ...
        this.bubble_v2 = builder.bubble_v2;
        Integer num57 = builder.is_mgc_account;
        if (num57 == null) {
            this.is_mgc_account = DEFAULT_IS_MGC_ACCOUNT;
        } else {
            this.is_mgc_account = num57;
        }
        Integer num58 = builder.truncate_line;
        if (num58 == null) {
            this.truncate_line = DEFAULT_TRUNCATE_LINE;
        } else {
            this.truncate_line = num58;
        }
        Integer num59 = builder.is_need_auto_at;
        if (num59 == null) {
    ...
    public static final class Builder extends Message.Builder<User> {
        ...
        public Builder(User user) {
            ...
            this.user_mark_list = Message.copyOf(user.user_mark_list);
            this.show_icon_list = Message.copyOf(user.show_icon_list);
            this.user_show_info = user.user_show_info;
            this.log_param = Message.copyOf(user.log_param);
            this.like_forum_scheme = user.like_forum_scheme;
            this.pa_type = user.pa_type;
            this.bubble_v2 = user.bubble_v2;
