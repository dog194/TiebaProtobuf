...
public final class VirtualImageInfo extends Message {
    ...
    public static final class Builder extends Message.Builder<VirtualImageInfo> {
        ...
        public Builder(VirtualImageInfo virtualImageInfo) {
            ...
            this.virtual_profile_image_url = virtualImageInfo.virtual_profile_image_url;
        }
    ...
    public VirtualImageInfo(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            String str4 = builder.virtual_profile_image_url;
            if (str4 == null) {
                this.virtual_profile_image_url = "";
                return;
            } else {
                this.virtual_profile_image_url = str4;
                return;
            }
        }
        ...
        this.virtual_profile_image_url = builder.virtual_profile_image_url;
    }
}