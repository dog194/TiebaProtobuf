...
public final class DataRes extends Message {
    ...
    public static final List<PopInfo> DEFAULT_POPUP_CONFIG = Collections.emptyList();
    public static final List<String> DEFAULT_LIMIT_DIALOG_NAME = Collections.emptyList();
    public static final List<FrsPageAreaCards> DEFAULT_AREA_DATA = Collections.emptyList();
    public static final Integer DEFAULT_PAGE_DATA_TAB_ID = 0;
    ...
    public static final class Builder extends Message.Builder<DataRes> {
        ...
        public Builder(DataRes dataRes) {
            ...
            this.popup_config = Message.copyOf(dataRes.popup_config);
            this.recom_forum = dataRes.recom_forum;
            this.limit_dialog_name = Message.copyOf(dataRes.limit_dialog_name);
            this.top_card_id = dataRes.top_card_id;
            this.send_thread_button_scheme = dataRes.send_thread_button_scheme;
            this.send_thread_button_icon_url = dataRes.send_thread_button_icon_url;
            this.area_data = Message.copyOf(dataRes.area_data);
            this.page_data_tab_id = dataRes.page_data_tab_id;
            this.frs_rain_info = dataRes.frs_rain_info;
        }
    ...
    public DataRes(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            List<FeedKV> list27 = builder.log_param;
            if (list27 == null) {
                this.log_param = DEFAULT_LOG_PARAM;
            } else {
                this.log_param = Message.immutableCopyOf(list27);
            }
            List<PopInfo> list28 = builder.popup_config;
            if (list28 == null) {
                this.popup_config = DEFAULT_POPUP_CONFIG;
            } else {
                this.popup_config = Message.immutableCopyOf(list28);
            }
            this.recom_forum = builder.recom_forum;
            List<String> list29 = builder.limit_dialog_name;
            if (list29 == null) {
                this.limit_dialog_name = DEFAULT_LIMIT_DIALOG_NAME;
            } else {
                this.limit_dialog_name = Message.immutableCopyOf(list29);
            }
            String str7 = builder.top_card_id;
            if (str7 == null) {
                this.top_card_id = "";
            } else {
                this.top_card_id = str7;
            }
            String str8 = builder.send_thread_button_scheme;
            if (str8 == null) {
                this.send_thread_button_scheme = "";
            } else {
                this.send_thread_button_scheme = str8;
            }
            String str9 = builder.send_thread_button_icon_url;
            if (str9 == null) {
                this.send_thread_button_icon_url = "";
            } else {
                this.send_thread_button_icon_url = str9;
            }
            List<FrsPageAreaCards> list30 = builder.area_data;
            if (list30 == null) {
                this.area_data = DEFAULT_AREA_DATA;
            } else {
                this.area_data = Message.immutableCopyOf(list30);
            }
            Integer num25 = builder.page_data_tab_id;
            if (num25 == null) {
                this.page_data_tab_id = DEFAULT_PAGE_DATA_TAB_ID;
            } else {
                this.page_data_tab_id = num25;
            }
            this.frs_rain_info = builder.frs_rain_info;
            return;
        }
        this.user = builder.user;
        this.forum = builder.forum;
        ...
        this.popup_config = Message.immutableCopyOf(builder.popup_config);
        this.recom_forum = builder.recom_forum;
        this.limit_dialog_name = Message.immutableCopyOf(builder.limit_dialog_name);
        this.top_card_id = builder.top_card_id;
        this.send_thread_button_scheme = builder.send_thread_button_scheme;
        this.send_thread_button_icon_url = builder.send_thread_button_icon_url;
        this.area_data = Message.immutableCopyOf(builder.area_data);
        this.page_data_tab_id = builder.page_data_tab_id;
        this.frs_rain_info = builder.frs_rain_info;
    }
}