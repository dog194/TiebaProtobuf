...
public final class DataReq extends Message {
    ...
    public static final Long DEFAULT_SCORE_ID = 0L;
    public static final Integer DEFAULT_SCORE = 0;
    public static final Integer DEFAULT_WITH_TAIL = 0;
    ...
    public static final class Builder extends Message.Builder<DataReq> {
        ...
        public Builder(DataReq dataReq) {
            ...
            this.score_id = dataReq.score_id;
            this.score_name = dataReq.score_name;
            this.score = dataReq.score;
            this.with_tail = dataReq.with_tail;
            this.tag_info = dataReq.tag_info;
        }
    ...
    public DataReq(Builder builder, boolean z) {
        ...
        if (z) {
            ...
            Long l = builder.activity_product_id;
            if (l == null) {
                this.activity_product_id = DEFAULT_ACTIVITY_PRODUCT_ID;
            } else {
                this.activity_product_id = l;
            }
            Long l2 = builder.activity_business_id;
            if (l2 == null) {
                this.activity_business_id = DEFAULT_ACTIVITY_BUSINESS_ID;
            } else {
                this.activity_business_id = l2;
            }
            Long l3 = builder.score_id;
            if (l3 == null) {
                this.score_id = DEFAULT_SCORE_ID;
            } else {
                this.score_id = l3;
            }
            String str68 = builder.score_name;
            if (str68 == null) {
                this.score_name = "";
            } else {
                this.score_name = str68;
            }
            ...
            Integer num4 = builder.with_tail;
            if (num4 == null) {
                this.with_tail = DEFAULT_WITH_TAIL;
            } else {
                this.with_tail = num4;
            }
            String str69 = builder.tag_info;
            if (str69 == null) {
                this.tag_info = "";
                return;
            } else {
        ...
        this.score_id = builder.score_id;
        this.score_name = builder.score_name;
        this.score = builder.score;
        this.with_tail = builder.with_tail;
